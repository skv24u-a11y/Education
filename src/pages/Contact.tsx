        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-seafoamBlue-100 max-w-4xl mx-auto">
              We're here to help you on your excellence journey. Get in touch with us today!
            </p>
          </div>
        </div>
      </section>
            ...
            {contactInfo.map((info, index) => (
              <div key={index} className="bg-white p-8 rounded-xl shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
                <div className={`w-16 h-16 ${info.color.replace('text-', 'bg-').replace('-600', '-100')} rounded-full flex items-center justify-center mx-auto mb-6`}>
                  <info.icon className={`w-8 h-8 ${info.color === 'text-orange-600' ? 'text-seafoamBlue-600' : info.color}`} />
                </div>
            ...
            <div>
              <div className="bg-white p-8 rounded-xl shadow-lg">
                <div className="flex items-center mb-6">
                  <MessageSquare className="w-8 h-8 text-seafoamBlue-600 mr-3" />
                ...
                {isSubmitted ? (
                  ...
                  <form action="https://formsubmit.co/admission@matipaacademy.online" method="POST" className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            name="name"
                            required
                            className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-seafoamBlue-500 focus:border-transparent"
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <textarea
                          ...
                          required
                          rows={6}
                          className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-seafoamBlue-500 focus:border-transparent resize-none"
                    ...
                    <button
                      type="submit"
                      className="w-full bg-gradient-to-r from-seafoamBlue-600 to-vibrantCoral-600 text-white py-4 px-6 rounded-lg font-semibold hover:from-seafoamBlue-700 hover:to-vibrantCoral-700 transition-all transform hover:scale-105 flex items-center justify-center"
                    >
            ...
            <div>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-red-50 p-8 rounded-xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center p-4 bg-white rounded-lg shadow-sm">
                    <MessageSquare className="w-6 h-6 text-seafoamBlue-600 mr-3" />
                    <div>
                  ...
                  <div className="flex items-center p-4 bg-white rounded-lg shadow-sm">
                    <Mail className="w-6 h-6 text-seafoamBlue-600 mr-3" />
                    <div>
