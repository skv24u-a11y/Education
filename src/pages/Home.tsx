    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-seaformBlue-500 to-seaformBlue-700 text-white overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute top-20 right-20 w-24 h-24 bg-white transform rotate-45"></div>
          <div className="absolute bottom-20 left-20 w-20 h-20 bg-white rounded-full"></div>
          <div className="absolute bottom-10 right-10 w-28 h-28 border-4 border-white transform rotate-12"></div>
        </div>
